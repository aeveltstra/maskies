...
/* package maskies-profiling-0.2.0.5 */
#ifndef VERSION_maskies_profiling
#define VERSION_maskies_profiling "0.2.0.5"
#endif /* VERSION_maskies_profiling */
#ifndef MIN_VERSION_maskies_profiling
#define MIN_VERSION_maskies_profiling(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
  (major1) == 0 && (major2) == 2 && (minor) <= 0)
#endif /* MIN_VERSION_maskies_profiling */
...
#define CURRENT_COMPONENT_ID "maskies-profiling-0.2.0.5-inplace-Maskies-Profiling"
