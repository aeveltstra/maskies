...
next D4LitLocker _ = D4LitOffice
...
next D4LitOffice K.A = D4LitLocker
next D4LitOffice K.D = D4LitDesk
next D4LitOffice K.W = D4LitFountain
next D4LitOffice K.S = D4LitMazeEntrance
next D4LitOffice _ = D4LitOfficeHelp
next D2LitDeskHelp K.S = D2LitMazeEntrance
...
next D2LitMirror _ = D2LitMirrorAttack
next D2LitMirrorAttack K.D = D2LitMirrorSurvive
next D2LitMirrorAttack _ = D2LitMirrorDeath
next D2LitMirrorSurvive _ = D2LitMazeEntrance
next D2LitMirrorDeath K.A = D1Intro
next D2LitMirrorDeath _ = Quit
next D2LitMazeEntrance K.S = D2LitOffice
next D2LitMazeEntrance _ = D2mA
next D4LitMazeEntrance K.S = D4LitOffice
next D4LitMazeEntrance _ = D4mA
next D4LitFountain K.S = D4LitMirrorSurvive
next D4LitFountain _ = D4LitMirrorAttack
next D4LitMirrorAttack K.D = D4LitMirrorSurvive
next D4LitMirrorAttack _ = D4LitMirrorDeath
next D4LitMirrorDeath K.A = D1Intro
next D4LitMirrorDeath _ = Quit
next D2mA K.Y = D2mAY
next D2mA _ = D2mAN
next D2mAN K.Y = D2mAY
next D2mAN _ = D2mAN
next D4mA K.Y = D4mAY
next D4mA _ = D4mAN
next D4mAN K.Y = D4mAY
next D4mAN _ = D4mAN
next D2mAY K.H = D2mAYHelp
next D2mAY K.A = D2mAYA
next D2mAY K.W = D2mAYW
next D2mAY K.D = D2mAYD
next D2mAY _ = D2mAY
next D4mAY K.H = D4mAYHelp
next D4mAY K.A = D4mAYA
next D4mAY K.W = D4mAYW
next D4mAY K.D = D4mAYD
next D4mAY _ = D4mAY
...
show :: Stage -> UserName -> TL.Text 

show Init _ = "Welcome to Maskie’s Ice Cream. What is your name? Type your name and press Enter:"

show Quit name = TL.replace "{name}" name "Come back to play another day, {name}? Bring your friends! Bye!"
...
show B1TheParlor name = TL.replace "{name}" name "You are in the ice cream parlor. It is closed for the night. The lights are off. You can make out tables and cabinets in the light of the moon. And what’s that? In the shadows behind the counter? Is that a person? Could be a thief! To do your duty and inspect the situation, press w. However, you might be a coward. Are you a coward, {name}? If so, press s to go back to the hallway. It won’t be any better, though. Now choose."

show B1TheParlorDeath name = TL.replace "{name}" name "You get attacked! You can’t see them: it’s too dark! Wasn’t there a lantern in the office? You really could’ve used that now. The attacker grabs you by the neck, and pulls you really close to their face. ITs face. It’s an animatronic. With no lips on a mouth filled with sharp metal teeth. Cameras instead of eyes. With an ice cream cone for 1 ear, and some wires where the other should have been. With bulbous arms that grab you and instead of a hand, an ice scoop that scoops out your eyes. It rips out your brain and eats it. That’s going to make a mess! Now choose: to reincarnate and try again, press a. To give up and quit, press q."

show B1DarkHallwayEnd name = TL.replace "{name}" name "At the far end of the hallway, you see a wall. A painting might be there, but it’s too dark to make out. As a matter of fact, you can hardly see anything. Better go back, {name}, and find some source of light. Press s to go back. Or press d to go right. Want to go left? Press a. There is a light there. To give up and quit, press q."

show B1DarkToilets name = TL.replace "{name}" name "You found the toilets. That will come in handy. It’s a bit dark in here. It smells clean. The tiles squeak under your shoes. Very clean. Someone did a good job. If only you had some light to really enjoy that. You hear water trickling. It reminds you of your bladder. What do you do? Stay here and take a wee in the dark? Press w. Or ignore your bladder and go back into the hallway and look for a light? If so, press s."

show B1DarkHallwayDeath name = TL.replace "{name}" name "What’s that? In the shadows? It’s moving fast. It’s coming for you, {name}! You try and get away, but it’s dark. It jumps on you. You fall over backwards, cracking your head on the floor. The squeaky clean floor. Not so clean anymore. You have nothing to protect yourself. The attacker weighs down on your chest. You can’t breathe. You can’t see anything anymore. Desparately you grasp for air and try to push away your attacker. To no avail. Good bye, {name}. Press a to reincarnate and try again. Press q to give up and quit."

show B1OfficeDesk name = TL.replace "{name}" name "The desk holds a lantern. It’s the only light in the room. You probably should pick it up and carry it around as you roam the premises. You know: so you don’t stumble over anything in the dark. To pick up the lantern, press y. Otherwise, press n."

show B1Locker name = TL.replace "{name}" name "The locker is really dark. You can’t see anything. Wouldn’t you feel better with a lantern? Didn’t you see one on the desk? To check the desk, press d. To rummage around the locker anyway, press w. To give up and quit, press q."
...
show B1OfficeFountain name = TL.replace "{name}" name "Aah, fresh, clean water! You needed that. It’s getting hot in here! There’s a mirror on the wall in front of you. To lean forward and look into the mirror, press w. To return to the office, press s."

show B1ViewMirror name = TL.replace "{name}" name "You see yourself, {name}. But it’s dark and your face shows many shadows and wrinkles. How do you feel? Tired? Hot? The cold water helped a bit. You probably need to come back here to stay cool. Why is it hot in here anyway? It’s an ice cream parlor. Maybe the heat helps sell more ice cream? Beads of sweat drip down the side of your face, onto your shirt. You wipe them off. Enough self-reflection. Let’s press s and get back to work. Or, if you prefer to give up and quit, press q."

show B2LitHallway name = TL.replace "{name}" name "You’re back in the hallway. You’re still alone. It’s still night 2. Your lantern helps you see. Where to? Forward: press w. Left: a. Right: d. You could give up now and press q. But you’ve come so far!"

show B2LitHallwayEnd name = TL.replace "{name}" name "On the far wall at the end of the hallway, you see a painting of an ice cream cone. Everything is squeaky clean. The cleaning crew must be doing a good job. Surely that’s needed to keep the animatronics in good shape. On top of the ice cream in the painting, you spot a red ball with a yellow smiley face. Like a gumball. Wouldn’t you like to eat some ice cream now? It is getting hot in here, after all. Press y for yes, n for no."

show B2Office name = TL.replace "{name}" name "You are in a office. Your lantern lights it up. To the right you see a desk. Against the far wall you see a water fountain. A locker is set against the left wall. Press w to cool down with some cold water from the fountain. Press d to check the desk. To inspect the locker, press a. To go back to the hallway, press s."

show B2Locker name = TL.replace "{name}" name "The locker contains cleaning supplies and 2 sets of clothes: a spare security guard uniform, and a cleaner’s outfit. Wouldn’t you like to inspect the cleaning supplies? If yes, press y. But you know that curiosity kills the cat. So maybe not? If not, press n."

show B2InspectSupplies name = TL.replace "{name}" name "A broom… a mop… a bucket with rags… You shouldn’t need these, {name}. You’re a security guard. That’s odd: something shiny is sticking out of the rags. Would a security guard ignore that? To ignore it and close the locker, press s. Otherwise, pick where to rummage: press a, w, or d:"

show B2aFind name = TL.replace "{name}" name "You found a shield! It’s shiny and pointy, a triangle with the point down, and fits snugly around your arm. {name}: you look tough now! It makes you feel invulnerable. Except for the painting of a poop tuft on the front. But maybe it will come in handy, later. So you keep the shield. Press s to study the shield at the desk. Still curious? Maybe pressing w or d will get you something else?"

show B2waFind name = TL.replace "{name}" name "You found a shield! It’s shiny and pointy, a triangle with the point down, and fits snugly around your arm. {name}: you look tough now! It makes you feel invulnerable. Except for the painting of a poop tuft on the front. But maybe it will come in handy, later. So you keep the shield. You already found a map. Press s to study them at the desk. Still curious? Maybe pressing d will get you something else?"

show B2daFind name = TL.replace "{name}" name "You found a shield! It’s shiny and pointy, a triangle with the point down, and fits snugly around your arm. {name}: you look tough now! It makes you feel invulnerable. Except for the painting of a poop tuft on the front. But maybe it will come in handy, later. So you keep the shield. You already found a memory stick. Press s to study them at the desk. Still curious? Maybe pressing w will get you something else?"
...
show B2awFind name = TL.replace "{name}" name "You found a map! It’s wrinkly and stained with water. People really have to take better care of their posessions. You already found a shield. Let’s have a closer look. Press s to study them at the desk. Still curious? Maybe pressing d will get you something else?"

show B2dwFind name = TL.replace "{name}" name "You found a map! It’s wrinkly and stained with water. People really have to take better care of their posessions. You already found a memory stick. Let’s have a closer look. Press s to study them at the desk. Still curious? Maybe pressing a will get you something else?"

show B2adwFind name = TL.replace "{name}" name "You found a map! It’s wrinkly and stained with water. People really have to take better care of their posessions. Let’s have a closer look. Press s to study your finds at the desk."

show B2wFind name = TL.replace "{name}" name "You found a map! It’s wrinkly and stained with water. People really have to take better care of their posessions. Let’s have a closer look. Press s to study it at the desk. Still curious? Maybe pressing a or d will get you something else?"

show B2adFind name = TL.replace "{name}" name "You found a memory stick! What would be stored on it? Must be important! Looks like you’ll need a USB port to plug that in. Press s to close the locker and return to the office. Still curious? You already found the shield. Maybe pressing w will get you something else?"

show B2wdFind name = TL.replace "{name}" name "You found a memory stick! What would be stored on it? Must be important! Looks like you’ll need a USB port to plug that in. You already found a map. Press s to study them at the desk. Still curious? Maybe pressing a will get you something else?"

show B2dFind name = TL.replace "{name}" name "You found a memory stick! What would be stored on it? Must be important! Looks like you’ll need a USB port to plug that in. Press s to study it at the desk. Still curious? Maybe pressing a or w will get you something else?"

show B2awdFind name = TL.replace "{name}" name "You found a memory stick! What would be stored on it? Must be important! Looks like you’ll need a USB port to plug that in. There is nothing else here. Press s to study your finds at the desk."
...
show B2ViewMirror name = TL.replace "{name}" name "You see yourself, {name}. The light from the lantern does you no favors. You straighten your hair. And spot something shoot by from the corner of your eye. What do you do? Chase it? Press w. Stay in the room and keep looking for other things that may help? Press s."

show B2TheParlor name = TL.replace "{name}" name "You are in the ice cream parlor. It is closed for the night. The lights are off, but your lantern spreads the light. You can make out tables and cabinets. And what’s that? In the shadows behind the counter? Is that an ice cream dispenser? Maskies does boast the best ice cream in the county! Let’s have some! Surely that will cool you down. Press y to eat some. Press s to return to the hallway. To quit, press q."

show B2EatIcecream name = TL.replace "{name}" name "This truly is the best ice cream ever. It’s clear why people would want to come here and have some. The ice cream tastes so good, that you forgot to wonder why the dispenser hadn’t been turned off. It’s midnight, after all. Shouldn’t it have been cleaned for hygiene? If you agree, press y. If not, press n."

show B2FoodPoisoning name = TL.replace "{name}" name "You don’t feel so good. Your stomach is growling. Better get to the bathroom, {name}, quickly! Press w to go visit the bathrooms. Or s to suck it up and ignore the pain."

show B2DieFromFoodPoisoning name = TL.replace "{name}" name "Best ice cream in the country, aye? Not so sure about that anymore, are you, {name}? Your belly swells up fast. It hurts! It explodes! Your guts get flung out all over the place. You fall down on your knees and then flat on your face. You would drown if the blood loss wouldn’t kill you first. Game over. Press q to quit. Or, to reincarnate and try again, press a. Don’t eat the ice cream, OK {name}?"

show B2LitToilets name = TL.replace "{name}" name "You found the toilets. Just in time! To go and do a number 2, pick any stall: a, w, or d. You’re all alone anyway. Or press s to back out now."

show B2FeelBetterNow name = TL.replace "{name}" name "Much better. What a relief! You sure could use cold drink of water now. Let’s head back, {name}. Press w to continue."

show B2HallwayDeath name = TL.replace "{name}" name "Oh how courageous! You ran after whatever it was, into the hallway. You can see it clearly now: it’s a pink animatronic cat! And it’s coming for you really fast! If only you had had something to protect yourself! But you don’t. Didn’t you see the shield in the office locker? Didn’t you take it? Why not? Too late now! The cat runs you over. It’s heavy. Way heavier than a real cat. Your bones crush and break as the cat claws into your body. Your scream is drowned out by the music. So loud! Then you faint. And die. Where does the cat go? Why did it attack you? No clue… yet. Want to find out? Press a to reincarnate and try again. Or run away and quit, by pressing q."

show B3Office name = TL.replace "{name}" name "No need to get your hands dirty, right {name}? After all you aren’t the cleaner. And the bucket won’t be stealing no ice cream. Alright. Let’s cool off with some cold water from the fountain. Press w. Or press d to take a break and sit down at the desk. Feel like quitting? Press q!"

show B3OfficeDesk name = TL.replace "{name}" name "Right. Let’s take a break. Securing the premises is tiring! You set the lantern down on the desk. That causes a small round shadow to appear. A shadow? You recognize it is cast by a button. What would that do? Want to find out, {name}? Press y for yes. Or be boring and press n for no."

show B3PressedButton name = TL.replace "{name}" name "Out of the middle of the desk, a screen flips up. It has a USB port on the side. But you have nothing to plug into it. Doesn’t it feel like you might be missing out on something important, {name}? Press y if so. If not, press n."

show B3OfficeFountain name = TL.replace "{name}" name "Suddenly you hear glass sliding on glass. The mirror mounted on the wall above the fountain slides away. The space behind it is dark. Something in there is making its way out into the light! Where you are, {name}! Jump out of the way, quick! Press a!"

show B3OfficeDeath name = TL.replace "{name}" name "Oh dear! It fell out, bumped on the fountain, and landed right on top of you! It’s a bunny? Blue and white, and fluffy… but big! And heavy! So heavy! It studies you. With square eyes. Does it seem confused? Hard to tell. It sniffs at your face. You struggle to push it off. Can’t… move! Can’t… breathe! Is that singing you hear? Crying? Can’t tell. Can’t… (Game over. Press q.)"

show B3aOfficeDesk name = TL.replace "{name}" name "You set your lantern down on the table. That causes a small round shadow to appear, that wasn’t there before. It’s a button. What do you do? To press the button, press y. Or maybe look for other objects hidden in the wash bucket? Get your hands dirty? If so, press d or w."

show B3dOfficeDesk name = TL.replace "{name}" name "You set your lantern down on the table. That causes a small round shadow to appear, that wasn’t there before. It’s a button. What do you do? To press the button, press y. Or maybe look for other objects hidden in the wash bucket? Get your hands dirty? If so, press a or w."

show B3wOfficeDesk name = TL.replace "{name}" name "You set your lantern down on the table. That causes a small round shadow to appear, that wasn’t there before. It’s a button. What do you do? To press the button, press y. Or maybe look for other objects hidden in the wash bucket? Get your hands dirty? If so, press a or d."

show B3adOfficeDesk name = TL.replace "{name}" name "You set your lantern down on the table. It lights up a button. What do you do? To press the button, press y. Or maybe look for another object hidden in the wash bucket? Get your hands dirty? If so, press w."

show B3dwOfficeDesk name = TL.replace "{name}" name "You set your lantern down on the table. It lights up a button. What do you do? To press the button, press y. Or maybe look for another object hidden in the wash bucket? Get your hands dirty? If so, press a."

show B3awOfficeDesk name = TL.replace "{name}" name "You set your lantern down on the table. It lights up a button. What do you do? To press the button, press y. Or maybe look for another object hidden in the wash bucket? Get your hands dirty? If so, press d."

show B3adwOfficeDesk name = TL.replace "{name}" name "You set your lantern down on the table. Next to it, you place the map and the memory stick. You keep the shield on your arm. Might come in handy. Now where can you plug in the memory stick? It looks like you need a USB port. On the desk you spot the round shadow of a button. Maybe that gives access to a USB port? To press the button, press y. To ignore it and resume guarding duty until the morning, press n."

show B4aPressedButton name = TL.replace "{name}" name "Out of the middle of the desk, a screen flips up. The screen starts playing a video. It’s another security guard. He seems afraid and tired. He shouts: “Get out! Get out now while you can! The animatronics! Ain’t no good! Far from! Someone’s done messed them up! Gotta figure out why and how to stop ’em! \nAnd the boss? Don’t let him trick you into the obstacle course! Bring a shield! Did you find the map? You’ll need it!” \nReally now? That’s a bit dramatic, isn’t it, {name}? The video continues: something jumped the security guard and they fell out of view. He’s screaming. Is that the sound of wet rags dropping on the floor? Oh dear, blood spatters? You look around the room: no blood anywhere, now. The video stopped. Was it a prank? It must have been a prank! Press y if so. If not, press n."

show B4dPressedButton name = TL.replace "{name}" name "Out of the middle of the desk, a screen flips up. It has a USB port on the side. You plug in the memory stick. The screen starts playing a video. It’s another security guard. He seems afraid and tired. He shouts: “Get out! Get out now! The animatronics! They ain’t OK! Far from! Someone’s done messed them up. Gotta figure out why and how to stop ’em! \nAnd the boss? Don’t let him trick you into the obstacle course! Did you find the shield and the map? You’ll need those!” \nReally now? That’s a bit dramatic, isn’t it, {name}? The video continues: something jumped the security guard and they fell out of view. He’s screaming. Is that the sound of wet rags dropping on the floor? Oh dear, blood spatters? You look around the room: no blood anywhere, now. The video stopped. Was it a prank? It must have been a prank! Press y if so. If not, press n."

show B4wPressedButton name = TL.replace "{name}" name "Out of the middle of the desk, a screen flips up. The screen starts playing a video. It’s another security guard. He seems afraid and tired. He shouts: “Get out! Get out now! The animatronics! They ain’t OK! No sir! Someone’s done messed them up. Gotta figure out why and how to stop ’em! \nAnd the boss? Don’t let him trick you into the obstacle course! Bring a map! Did you find the shield, too? You’ll need them!”. \nReally now? That’s a bit dramatic, isn’t it, {name}? The video continues: something jumped the security guard and they fell out of view. He’s screaming. Is that the sound of wet rags dropping on the floor? Oh dear, blood spatters? You look around the room: no blood anywhere, now. The video stopped. Was it a prank? It must have been a prank! Press y if so. If not, press n."

show B4awPressedButton name = TL.replace "{name}" name "Out of the middle of the desk, a screen flips up. The screen starts playing a video. It’s another security guard. He seems afraid and tired. He shouts: “Get out! Get out now! The animatronics! They ain’t OK! No sir! Someone’s done messed them up. Gotta figure out why and how to stop ’em! \nAnd the boss? Don’t let him trick you into the obstacle course! Bring a map and a shield! You’ll need them!”. \nReally now? That’s a bit dramatic, isn’t it, {name}? The video continues: something jumped the security guard and they fell out of view. He’s screaming. Is that the sound of wet rags dropping on the floor? Oh dear, blood spatters? You look around the room: no blood anywhere, now. The video stopped. Was it a prank? It must have been a prank! Press y if so. If not, press n."

show B4EndOfShift name = TL.replace "{name}" name b4EoSMsg
show B4aEndOfShift name = TL.replace "{name}" name b4EoSMsg
show B4wEndOfShift name = TL.replace "{name}" name b4EoSMsg
show B4awEndOfShift name = TL.replace "{name}" name b4EoSMsg
show B4pEndOfShift name = TL.replace "{name}" name b4pEoSMsg
show B4paEndOfShift name = TL.replace "{name}" name b4pEoSMsg
show B4pwEndOfShift name = TL.replace "{name}" name b4pEoSMsg
show B4pawEndOfShift name = TL.replace "{name}" name b4pEoSMsg

show B4Ridicule name = TL.replace "{name}" name b4RidiculeMsg
show B4aRidicule name = TL.replace "{name}" name b4RidiculeMsg
show B4wRidicule name = TL.replace "{name}" name b4RidiculeMsg
show B4awRidicule name = TL.replace "{name}" name b4RidiculeMsg

show C1Welcome name = TL.replace "{name}" name c1Msg
show C1aWelcome name = TL.replace "{name}" name c1Msg
...
show C3fawDeathBelow name = TL.replace "{name}" name "Cold metal claws wrap around your arms and pull you under. Your shield does nothing to protect you: those claws are too strong. The soggy, disgusting not-bean clumps smack into your face. They feel and smell like cuts of veal… or worse… This is an ice cream parlor after all: no veal here. That and other thoughts race through your mind. Weird. So this is game over, {name}. Want to try again? Press a to reincarnate and try again. Or press q to quit."
show C3fwDeathBelow name = TL.replace "{name}" name "Cold metal claws wrap around your arms and pull you under. Your map does nothing to protect you: those claws are too strong. The soggy, disgusting not-bean clumps smack into your face. They feel and smell like cuts of veal… or worse… This is an ice cream parlor after all: no veal here. That and other thoughts race through your mind. Weird. So this is game over, {name}. Want to try again? Press a to reincarnate and try again. Or press q to quit."

show C3fDeathAbove name = TL.replace "{name}" name c3fDeathAboveMsg 

show C4 name = TL.replace "{name}" name c4Msg
show C4a name = TL.replace "{name}" name c4Msg
show C4aw name = TL.replace "{name}" name c4wMsg
show C4w name = TL.replace "{name}" name c4wMsg

show C5 name = TL.replace "{name}" name c5Msg
show C5a name = TL.replace "{name}" name c5Msg
show C5w name = TL.replace "{name}" name c5Msg
show C5aw name = TL.replace "{name}" name c5Msg

show C6 name = TL.replace "{name}" name (TL.concat [c6Msg, "Which is pretty amazing since you have neither a shield nor a map. ", c6Msg2])
show C6a name = TL.replace "{name}" name (TL.concat [c6Msg, "Which is pretty amazing since you have no map. But luckily your shield protected you. ", c6Msg2])
show C6w name = TL.replace "{name}" name (TL.concat [c6Msg, "Aren’t you happy you have that map? Might have been easier with a shield, too. ", c6Msg2])
show C6aw name = TL.replace "{name}" name (TL.concat [c6Msg, "That map and shield really helped. Better hang on to them. ", c6Msg2])

show C6f name = TL.replace "{name}" name (TL.concat [c6fMsg, "You have nothing to protect yourself. No shield. How brave. ", c6fMsg2])
show C6fa name = TL.replace "{name}" name (TL.concat [c6fMsg, "You hold up your shield. ", c6fMsg2])
show C6faw name = TL.replace "{name}" name (TL.concat [c6fMsg, "You hold up your shield. ", c6fMsg2])
show C6fw name = TL.replace "{name}" name (TL.concat [c6fMsg, "You pull out your map, rip it up, and throw it into the air in an attempt to distract them. ", c6fMsg2])

show C6Attack name = TL.replace "{name}" name (TL.concat [c6AttackMsg, "And you ain’t got no shield. No nothing. ", c6AttackMsg2])
show C6aAttack name = TL.replace "{name}" name (TL.concat [c6AttackMsg, "You have a shield. Will it help? ", c6AttackMsg2])
show C6wAttack name = TL.replace "{name}" name (TL.concat [c6AttackMsg, "And you ain’t got no shield. No map. ", c6AttackMsg2])
show C6awAttack name = TL.replace "{name}" name (TL.concat [c6AttackMsg, "You have a shield and a map. Will they help? ", c6AttackMsg2])

show C6Survive name = TL.replace "{name}" name c6SurviveMsg
show C6aSurvive name = TL.replace "{name}" name c6SurviveMsg
show C6awSurvive name = TL.replace "{name}" name c6SurviveMsg

show C6Death name = TL.replace "{name}" name (TL.concat [c6DeathMsg, "You try and fend them off as best you can. ", c6DeathMsg2])
show C6aDeath name = TL.replace "{name}" name (TL.concat [c6DeathMsg, "You fend them off with your shield, but there’s too many! ", c6DeathMsg2])
show C6awDeath name = TL.replace "{name}" name (TL.concat [c6DeathMsg, "You fend them off with your shield, but there’s too many! You even rip up your map and throw it into the air as a distraction. It doesn’t work. ", c6DeathMsg2])

show C7 name = TL.replace "{name}" name c7Msg
show C7a name = TL.replace "{name}" name c7Msg
show C7w name = TL.replace "{name}" name c7Msg
show C7aw name = TL.replace "{name}" name c7Msg

show C9 name = TL.replace "{name}" name c9Msg
show C9a name = TL.replace "{name}" name c9Msg
show C9w name = TL.replace "{name}" name c9Msg
show C9aw name = TL.replace "{name}" name c9Msg

show C10 name = TL.replace "{name}" name (TL.concat [c10Msg, "Don’t you wish you had a shield to protect you? Better run away!", c10Msg2])
show C10a name = TL.replace "{name}" name (TL.concat [c10Msg, "Luckily you have a shield to protect you. Use that to block any attack. ", c10Msg2])
show C10aw name = TL.replace "{name}" name (TL.concat [c10Msg, "Luckily you have a shield to protect you. Use that to block any attack. ", c10Msg2])
show C10w name = TL.replace "{name}" name (TL.concat [c10Msg, "Don’t you wish you had a shield to protect you? Better run away!", c10Msg2])

show C8 name = TL.replace "{name}" name c8Msg
show C8a name = TL.replace "{name}" name c8Msg
show C8w name = TL.replace "{name}" name c8Msg
show C8aw name = TL.replace "{name}" name c8Msg

show C10Attack name = TL.replace "{name}" name (TL.concat [c10AttackMsg, "If only you’d have had some shield or anything to protect you! ", c10AttackMsg2])
show C10aAttack name = TL.replace "{name}" name (TL.concat [c10AttackMsg, "You have a shield. That could protect you. But you know what’s a wise action? ", c10AttackMsg2])
show C10wAttack name = TL.replace "{name}" name (TL.concat [c10AttackMsg, "You have a map. Will that protect you? Wouldn’t you rather have had a shield? ", c10AttackMsg2])
show C10awAttack name = TL.replace "{name}" name (TL.concat [c10AttackMsg, "You have a map. That won’t protect you! You have a shield too. That could. But you know a good choice? ", c10AttackMsg2])

show C10Death name = TL.replace "{name}" name (TL.concat [c10DeathMsg, "You duck to the ground to avoid the smoke. ", c10DeathMsg2])
show C10aDeath name = TL.replace "{name}" name (TL.concat [c10AttackMsg, "You duck to the ground to avoid the smoke, and raise your shield above your head. ", c10DeathMsg])
show C10wDeath name = TL.replace "{name}" name (TL.concat [c10DeathMsg, "You duck to the ground to avoid the smoke, and cover your mouth and nose with the map, hoping it acts as a filter. ", c10DeathMsg2])
show C10awDeath name = TL.replace "{name}" name (TL.concat [c10DeathMsg, "You duck to the ground to avoid the smoke, cover your mouth and nose with the map to act as a filter, and raise the shield above your head. ", c10DeathMsg2])

show C11 name = TL.replace "{name}" name (TL.concat [c11Msg, "Masquie sees you lack any kind of protective gear. “How brave! Weren't you scared?” ", c11Msg2])
show C11a name = TL.replace "{name}" name (TL.concat [c11Msg, "Masquie sees your shield. “Nice touch. Did it help?” ", c11Msg2])
show C11w name = TL.replace "{name}" name (TL.concat [c11Msg, "Masquie sees your map. “Nice touch. Did it help?” ", c11Msg2])
show C11aw name = TL.replace "{name}" name (TL.concat [c11Msg, "Masquie sees your shield and map. “Nice touch. Did they help?” ", c11Msg2])

show D1Intro name = TL.replace "{name}" name "This is night 4. You’re back in Maskie’s Ice Cream Parlor. I guess we did a bad job at scaring you off. We’ll try again! Your employer Jacques Masquie ran yet another special event for the customers. Maybe he left a letter about it on the desk in the office. Maybe not. Wouldn’t you like to find out, {name}? If yes, press w. For help, press h. Or press q to quit."

show D1Help name = TL.replace "{name}" name "Maskie’s Ice Cream Parlor is a text adventure game. It makes you read a lot. In night 4 you get to navigate a maze. Your objective is to stay alive and reach the exit. And maybe save the lives of some customers. Make sure to read the hints and clues, and pick up anything that might help you survive. At any point in the game you can type q to quit. Other keys will be announced when available. Good luck, {name}. Press s to continue."

show D1DarkHallway name = TL.replace "{name}" name "You’re in the hallway, {name}. You hear children’s music. They really ought to turn that off after hours. The hallway is dark, but for a few security lights. They show doors to the left and right, and more hallway forward. On the wall at the end of the hallway you see a painting. It looks different from before. Wouldn’t you like to study it from close by? If yes, press w. To turn left, press a. There’s a light there. Press d to turn right."

show D1DarkHallwayEnd name = TL.replace "{name}" name "You reached the end of the hallway. The music is louder here. The toilets are to the left. The ice cream parlor is to the right. And a painting is mounted on the wall in front of you. It looks different from before. That red gumball with the yellow smiley face… is it sticking out? And is that the source of the music? It may have holes for a speaker… Hard to tell, with so little light. Maybe head back and fetch a light, {name}? If so, press s. Or go left by pressing a. Press d to turn right."

show D1DarkOffice name = TL.replace "{name}" name "This is the office. It’s dark. A desk stands at the right wall. A lantern is set atop the desk. Would you like to inspect the desk? If so, press d. Against the left wall you see a storage locker. Press a to look through the locker. The far wall features a fountain with a mirror. To have a cold drink, press w. It is getting hot in here, again. Or if you choose to quit, {name}, press q."

show D1DarkDesk name = TL.replace "{name}" name "The desk holds a lantern. It’s the only light in the office besides the security beacon above the door. Wouldn’t you like to pick it up, so you don’t stumble around in the dark? Press y to pick it up. Press n to ignore it. I wouldn’t. But hey, I’m not playing."

show D1DarkDeskHelp name = TL.replace "{name}" name "No. Your options were to press either y or n. Press s now to go back to the desk and press the correct key. Want to quit? Press q!"

show D1DarkLocker name = TL.replace "{name}" name "This is the storage locker. There really isn’t enough light here to see what’s in it. 2 Days ago it held some uniforms, a broom, a mop, and a bucket. A uniform is missing. Do you really want to poke around in the dark? If so, press w. But wouldn’t you rather close the locker and look for a light? Press s to do that, {name}."

show D1DarkLockerAttack name = TL.replace "{name}" name "Hey, that hurt! What’s poking you? And from all sides? And the door closed behind you! You want to push it open, but your hand gets stabbed. You move your hand, and it gets stabbed again! There’s spikes or knives all over! And they’re getting closer! You feel around for an opening. Maybe duck? Jump up? Oh no: the entire locker falls over with you in it! Oh, dear. Erm. That’s a mess. Erm. So. I guess this is game over? Press a to reincarnate and try again, or q to quit."

show D1DarkFountain name = TL.replace "{name}" name "Ah yes, the fountain. Good for a refreshing cold drink. Someone should check out the airconditioning. Not you. Are you a mechanic? Thought so. Not hired to be one here. Here you are a security guard. Let’s go, do some securing. Press s to head back, {name}. Or maybe have that cold drink, first. Press d to drink. Or would you rather study your face in the mirror? If yes, press w."

show D1DarkDrink name = TL.replace "{name}" name "Nothing better than a cold drink on a hot night, right, {name}? But now you have to pee. Better go find those toilets. You know where they are, don’t you? Press w to go there now. Or would you rather ignore your bladder and pretend to be strong? You know you can’t hold it forever, you know. Press s to self-hypnotize and not feel the pressure."

show D1DarkMirror name = TL.replace "{name}" name "You reflect upon your face. Is this a trick mirror? It seems you grew a few more gray hairs since last time. This job must be getting to you. And what’s with the wrinkles around your eyes? The poor light really deepens those shadows, {name}. Suddenly something red and small jumps into the corner of the mirror. Turn around to face it, quick! Press a!"

show D1DarkMirrorAvoid name = TL.replace "{name}" name "The office is empty. Whatever red thing jumped into your view in the mirror, now it is gone. You feel your heart beating in your chest. Your ears are hot with blood. Surely you’re blushing now, and no-one can see. Because it’s too dark. Why didn’t you pick up that lantern yet, {name}? It’s on the desk. Right there. Press a to check the desk."

show D1DarkMirrorAttack name = TL.replace "{name}" name "Your choice. Not wise, though. You get bumped by someone or something you can’t even see. They knock you onto the floor. And they’re singing? To children’s music? They sit on your back: you can’t even look at their face. Ah! Pain! You got punched! Oh no, worse! They’re hammering on your back! It hurts! Scream! Struggle! Try and shove them off! Press s!"

show D1DarkMirrorDeath name = TL.replace "{name}" name "So sad. You never even got to see their face. Anyway, you’re dead now. What a mess. The cleaning crew is not going to be happy about that. You really should have picked up that lantern, {name}. But hey, what do I know? I just work here. So I guess this is game over. Good job though, getting this far. As a reward, if you reincarnate, you’ll jump straight back into night 4. Press a to do that. Or give up and quit, by pressing q."

show D1DarkToilets name = TL.replace "{name}" name "You found the toilets. And just in time! You realize your bladder has been bugging you for a while. It smells clean in here, but it’s a bit too dark for your liking. What do you do? Go back to the office to pick up the lantern from the desk? Or stay here and pee in the dark? Press s to go back. Otherwise, {name}, pick a stall: a, w, or d."

show D1DarkToiletsAttack name = TL.replace "{name}" name "So. That stall. Why that one? Anyway, it’ll do, I’m sure. Alright. Go ahead. Do your thing. I’ll wait. \r\n\r\nDone yet, {name}? \r\n\r\nWhat’s that? Did you hear that? That buzzing? Almost like static electricity? And hammering now? What on earth? Pull up those pants! You gotta go! I mean: get out of here! Press s now!"

show D1DarkToiletsDeath name = TL.replace "{name}" name "Why? Is pressing the correct key so hard? You could have survived that, you know. But nooo, {name} has to rebel. Well. Tough. You’re dead. You got knocked upside the head by a flying red ball with a yellow smiley face. It hammered your head in. Gross: your brains splattered all over the toilet and the stall walls. Wanna try that again? Press a to reincarnate and have another go. Or give up! Press q to quit."

show D1DarkToiletsSurvive name = TL.replace "{name}" name "Just in time you duck out of the way. A red ball flies through the air, wielding a hammer, aiming for your head. It has a yellow smiley painted on. Haven’t you seen that somewhere before? Instead of your head, it flies into the door. And now it’s trying to hammer down that door. Better make a run for it. Press d to head back into the hallway, or w to jump into the ice cream parlor. Make up your mind, {name}! Choose now!"

show D3DarkDesk name = TL.replace "{name}" name "Strong-headed, are we? Good for you! Don’t let a game tell you what to do! Even though it strongly hints you in the best direction! Besides, there’s a letter on the desk that requires your attention. Wouldn’t you like to read it, {name}? Might help. If so, press h."

show D3DarkDeskHelp name = TL.replace "{name}" name "The letter is from your employer, Jacques Masquie. It reads: \r\n\r\n“Dear {name}, \r\nWe have received some customer complaints. Some people got left behind in the obstacle course yesterday. You should have found them and flushed them out. You failed. Some customers got hurt by our animatronics. We have had to turn those off, and pay the customers’ hospital bills. Do not let that happen again. \r\nSigned, \r\nJacques Masquie, owner.” \r\nErm. OK, then. Press s to put down the letter. Or admit defeat and press q to quit."

show D3DarkDeskVideo name = TL.replace "{name}" name "You twiddle your thumbs on the desk in real authentic security guard fashion. Accidentally your one thumb hits a button. You knew it was there from the other day. A screen rises up from the desk. It starts playing a video. It shows a different security guard. She wears a uniform like your’s. But something is wrong with her face: it’s too round, and too red, and her smile seems painted on in yellow. Oh no! That is not her face at all! Press s to close the screen. What does it mean?"

show D3DarkOffice name = TL.replace "{name}" name "Alright. Enough is enough. Let’s get out of here. This building has 2 exits: the side door and the parlor door. Press d to take a right turn and exit out the side door. Press w to go forward into the ice cream parlor. Press a to turn left instead. For reasons, I guess. Which way, {name}?"

show D1DarkParlor name = TL.replace "{name}" name "It’s a bit darker here than usual. The security lights are off? Why? You can’t really see where you’re going. The counter should be to your left, and a gratuity ice cream dispenser to the right. But you can’t see them. The front door should be forward. Can’t see that either. Maybe you should go fetch a light. Where do you want to go, {name}? Press a for left, d for right, w for forward, or s for back to the hallway."

show D1DarkMazeEntrance name = TL.replace "{name}" name "Sure. Why not, {name}? Walk on in the dark. You just bumped into a wall you didn’t even see. You can’t go any further forward. I guess that door isn’t where you thought it was. You stretch out your arms and feel left and right: there seem to be hallways there. Would you like to turn left? If so, press a. Press d to turn right. Or go back to the hallway: press s. Last chance to get out. Choose wisely."

show D1DarkMazeAttack name = TL.replace "{name}" name "You hear something. Voices. People talking. Children. Customers stuck in the maze? “Hello!” The voices stop. A spark lights up the hallway. And someone’s face. A girl. Another spark. She’s right in front of you! You back away. And fall over backwards. You hear the girl following you. And the smell: motor oil. That’s no girl. The hand that grabs you is too strong. Lifts you right up off the floor. To struggle loose, press s."

show D1DarkMazeDeath name = TL.replace "{name}" name "How hard is it to press S, {name}? Very hard, apparently. Did you think I was joking? You were wrong. That not-a-girl that lifted you up like you weigh nothing? It has a hammer. You can’t see it. But you can feel it. Again. And again. And then nothing. Because you’re dead. You made some bad choices there. Want to try again? Press a to reincarnate. Or quit? Press q."
...
show D2LitMirrorDeath name = TL.replace "{name}" name "Erm. Taking risks is one thing. Getting your head hammered in because you refuse to press d is another. Why, {name}? Why couldn’t you simply press d? Look at you now. Your head in the sink. It turns red with blood and bits of brain. And a puddle of pee is forming around your feet. Gross! Well I guess this is good-bye. Unless you want to reincarnate and try again. In which case you can press a."

show D4LitMirrorDeath name = TL.replace "{name}" name "Erm. Taking risks is one thing. Getting your head hammered in because you refuse to press d is another. Why couldn’t you simply press d, {name}? Look at you now. Your head in the sink. It turns red with blood and bits of brain. And a puddle of pee is forming around your feet. Gross! So I guess this is good-bye, {name}. Unless you want to reincarnate and try again? In that case you can press a."
...
show D4LitMirrorAttack name = TL.replace "{name}" name "You ducked. The flying thing misses you. Which lets you have a good look. It’s a ball. A red ball. With a yellow smile. And a hammer. Which is hammering at the air. Because you’re not there. But you were. And happy to have ducked. Here it comes again. Press d, quick!"

show D4LitMirrorSurvive name = TL.replace "{name}" name "Good going! Now you remember: you have seen that ball before, {name}. On the painting at the end of the hallway. On the ice cream. Why did it get out? And did it attack you? And where is it heading now? Good questions! Let’s find out, shall we? Press w to follow the flying ball! Or press q to quit. Your choice, really."

show D4LitMazeEntrance name = TL.replace "{name}" name "You’re in a hallway you had not yet seen before. Despite having been here for 4 days. Maybe you have been here before, but it was too dark to see anything? There’s 4 exits: forward (w), left (a), right (d), and back (s). A red ball flew to the right. It wields a wooden hammer, and a yellow smile is painted on its front. Do you follow it? If so, press d. Otherwise, press w, a, or s."

show D2mA name = TL.replace "{name}" name (TL.replace "{map}" ", and you have a map" mA)
show D4mA name = TL.replace "{name}" name (TL.replace "{map}" "" mA)

show D2mAN name = TL.replace "{name}" name mAN
show D4mAN name = TL.replace "{name}" name mAN

show D2mAY name = TL.replace "{name}" name (TL.replace "{map}" "To consult your map, press h." mAY)
show D4mAY name = TL.replace "{name}" name (TL.replace "{map}" "" mAY)
...
mAN :: TL.Text
mAN = "Stubborn as usual, are we, {name}. Well. I guess you’re stuck here. Unless you want to read that sign now. Press y at any time. I’ll wait."

mA :: TL.Text
mA = "Whoops: you dropped into a hole. A cube with a gym mat on the floor, for a safe landing. Plenty of light. Children’s music and low hum. And you hear people speaking, but see no one. You see no way out. There is however a sign{map}. Would you like to read the sign, {name}? Press y for yes, n for no."
